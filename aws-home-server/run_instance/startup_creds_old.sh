...
# 0. leave existing running because we need to check the cost and hold the current certs.     
# 1. need AWS folders created, home, letsencrypt, var/www/html 
#    create user wit id and secret
#    create buckets
#    create role for the users    
# 2. call duplicati with user id and secret for launch     

echo "-------------------------- lets encrypt setup  Do after estore? ------------------------------------"
